class KnowledgeAreaLessonPlanPdf < BaseReport
  ...
  def class_plan
    ...
    text_box_dynamic_height(actives_methodology_label, (@knowledge_area_lesson_plan.lesson_plan.activities || '-'))
    text_box_dynamic_height(resources_label, (@knowledge_area_lesson_plan.lesson_plan.resources || '-'))
    text_box_dynamic_height(evaluation_label, (@knowledge_area_lesson_plan.lesson_plan.evaluation || '-'))
    text_box_dynamic_height(references_label, (@knowledge_area_lesson_plan.lesson_plan.bibliography || '-'))
  end
