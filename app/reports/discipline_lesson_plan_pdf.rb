class DisciplineLessonPlanPdf < BaseReport
  ...
  def class_plan
    ...
    begin
      activities_text = process_html_text(lesson_plan.activities) || '-'
    ...
    begin
      resources_text = process_html_text(lesson_plan.resources) || '-'
    ...
    begin
      evaluation_text = process_html_text(lesson_plan.evaluation) || '-'
    ...
    begin
      references_text = process_html_text(lesson_plan.bibliography) || '-'
