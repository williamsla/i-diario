$(document).ready(function () {
  $('#all-unities').click(function () {
    ...
    unities = $("#copy_knowledge_area_teaching_plan_form_unities_ids").attr('data-elements');
    ...
    $("#copy_knowledge_area_teaching_plan_form_unities_ids").val(unities.join(','));
  ...
  $('#all-grades').click(function () {
    ...
    grades = $("#copy_knowledge_area_teaching_plan_form_grades_ids").attr('data-elements');
    ...
    $("#copy_knowledge_area_teaching_plan_form_grades_ids").val(grades.join(','));
