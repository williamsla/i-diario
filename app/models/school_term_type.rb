class SchoolTermType < ApplicationRecord
  ...
  def self.to_select2(year, unity_id, grade_id, add_yearly: true, add_empty_element: true)
    term_types = current_year_school_term_types(year, unity_id, grade_id, add_yearly)
